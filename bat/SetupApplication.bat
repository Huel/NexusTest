...
:: Android packaging
set AND_CERT_NAME="NexusTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\NexusTest.p12
...
set IOS_PROVISION=cert\NexusTest.mobileprovision
...
set APP_ID=air.NexusTest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=NexusTest
